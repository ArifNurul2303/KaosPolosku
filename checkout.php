...
<html>
<head>
<title>KaosPolosku - Checkout</title>
<!-- for-mobile-apps -->
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di KaosPolosku</span></h1>
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas belum termasuk ongkir,ongkir akan dibayar ditempat</h2>
