...
<html>
<head>
<title>KaosPolosku - Keranjang Saya</title>
<!-- for-mobile-apps -->
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						?>
						<li>Total (Belum Ongkir)<i> - </i> <span>Rp<?php echo number_format($subtotal) ?></span></li>
					</ul>
				</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>KaosPolosku, Situbondo.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="humanixty@gmail.com">info@email</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 82333044177</li>
					</ul>
				</div>
